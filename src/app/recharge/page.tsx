...
export default function RechargePage() {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText("01775968585");
        setIsCopied(true);
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px" }}>
                                    ...
                                    <p style={{ fontSize: "1.1rem", color: "white", fontWeight: "800" }}></p>
                                    <button
                            ...
                            <div style={{
                                ...
                                <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px" }}>
                                    <p style={{ fontSize: "1.1rem", color: "white", fontWeight: "800" }}>01775968585</p>
                                    <button
                                        onClick={handleCopy}
                                        style={{
