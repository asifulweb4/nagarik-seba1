...
const services = [
    ...
    { id: 2, category: "NID & Smart Card", name: "NID সাইন কপি (ভোটার নাম্বার)", price: "৬৫৳" },
    { id: 3, category: "NID & Smart Card", name: "ফরম নাম্বার দিয়ে সাইন কপি", price: "৬৫৳" },
    { id: 4, category: "NID & Smart Card", name: "অফিসিয়াল সার্ভার কপি (NID)", price: "৭০৳" },
    ...
    { id: 23, category: "NID & Smart Card", name: "Nid pdf", price: "৭০৳" },
    ...
    { id: 19, category: "Doc & Services", name: "নতুন জন্ম নিবন্ধন", price: "৬১০৳" },
